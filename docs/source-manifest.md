...
| --- | --- | --- | --- | --- |
| `cambridge-young-learners-wordlist-2025.md` | Cambridge English *Pre A1 Starters, A1 Movers and A2 Flyers Word List*, 2025 edition; imported Markdown export, upstream URL/capture method not yet recorded | Current working curriculum reference | `f9c0b4a378b7bc7911adaaa3ccec81e1cd2064fd65b1aeb919cc1fd8ec811fb5` | **Pending academic provenance and citation verification** (`GATE-ACADEMIC-SOURCES`) |
| `cambridge-young-learners-handbook.md` | Cambridge English young learners handbook; imported Markdown export, publication edition/upstream URL/capture method not yet recorded | Current working assessment-format evidence, subordinate to approved product contracts | `48f514ae85f4abb20ffbee8790b7e4fb67cc7ce9e367f02320d5c55017bbd4d8` | **Pending academic provenance and citation verification** (`GATE-ACADEMIC-SOURCES`) |
| `cambridge-young-learners-wordlist.md` | Cambridge English word list labelled “for exams from 2018”; imported Markdown export, upstream URL/capture method not yet recorded | Historical reference only | `36c3792804825ee5e52eb3f5ff872a9553cc2b3d24ce0d0adeb2ad057d2a90e4` | **Historical; do not use to fill 2025 gaps**. Pending provenance verification |
