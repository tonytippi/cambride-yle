...
export async function GET(request: NextRequest) {
  ...
  const attemptMedia = !token && actor ? await getAttemptMedia(actor, { setId: request.nextUrl.searchParams.get("setId"), attemptId: request.nextUrl.searchParams.get("attemptId"), mediaId: request.nextUrl.searchParams.get("mediaId") }) : undefined;
