...
export type PracticePlayerItem = { id: string; position: number; engine: LearnerEngine; prompt: string; options: string[]; response?: string | boolean | number; media: { id: string; type: "audio" | "image"; altText?: string; choiceLabel?: string }[] };
